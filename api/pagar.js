...
module.exports = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      mode: 'payment',
      // Sin "payment_method_types": Checkout ofrece automáticamente los
      // métodos activos en la cuenta (tarjeta ya, Bizum en cuanto se active
      // en el Dashboard) — así no hace falta tocar código al activar Bizum,
      // y nunca falla por pedir un método que aún no está habilitado.
